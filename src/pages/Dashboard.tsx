...
export const Dashboard = () => {
  ...
  // Enhanced recommendations hook - no user ID needed, backend gets from session
  const {
    recommendations,
    metadata,
    isLoading,
        ...
        if (response.ok) {
          ...
          if (data.success) {
            ...
            setPurchasedTemplates(data.purchases.map(purchase => {
              ...
              // Ensure amountPaid is properly set
              ...
              return {
                ...
                ...purchase.template,
                // Add the purchased flag that TemplateCard expects
                purchased: true,
                // Set amountPaid at the root level
  ...
  // Add retry function for failed purchases
